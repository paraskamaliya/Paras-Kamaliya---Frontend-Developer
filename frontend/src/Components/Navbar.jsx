...
const Navbar = () => {
    return <div className="flex justify-between items-center bg-Navbar border border-NavbarBorder px-4 py-8 ml-10 mr-10 mt-10 mb-0 rounded-2xl bg-gradient-to-r from-right to-left h-22 gap-2 sticky top-10 z-100 backdrop-filter backdrop-blur-md">
        <div className="w-[50%]">
