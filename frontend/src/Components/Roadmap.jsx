const Roadmap = () => {
    return <div className="text-white 2xl-[100%]">
        <div className="bg-bitCoinColor p-[5%]">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="177" height="20" viewBox="0 0 177 20" fill="none" className="absolute left-[8%] z-1">
                <path d="M0.551003 18.3865C48.1951 6.09829 115.064 -0.428688 176.712 2.97441" stroke="#515151" stroke-width="3" />
            </svg>
            <div className="flex overflow-x-scroll overflow-y-auto cursor-grab active:cursor-grabbing gap-[5%] mt-[5%] max-w-[100%]">
